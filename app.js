document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(index){
        ...
        squares[i].onclick = function(){
            ...
            if(squares[index + 7].classList.contains('taken')) {
                ...
                //if the squares below your current square is not taken, you can't go here
    ...
    //now take the 4 values in ecah winnningArrays and plug them onto the squares
    for (let y= 0; y < winningArrays.length; y++){
        ...
        //now check to see if they all have the class name of player-teo
